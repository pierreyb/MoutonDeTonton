...
class LutteForm(forms.ModelForm):
    class Meta:
        model = Lutte
        fields = ['name_male', 'alive_number', 'dead_number', 'birth_weight_1', 'birth_weight_2', 'birth_weight_3',
                  'bred_number', 'sex', 'remark', 'lutte_type', 'code', 'male_number', 'mouton_number']
